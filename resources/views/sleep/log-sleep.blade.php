...
<script>
    document.title = "StudentWell | Log Sleep";
</script>
@if (session('success'))
    ...
    <div class="container">
        ...
        <div class="mb-3">
            <a href="{{ route('sleep.index') }}" class="back-link h2 fw-bold">
                <i class="fa fa-chevron-left me-2 h4 fw-bold"></i>Log Sleep
            </a>
        </div>
                        ...
                        <div class="left-column-wrapper d-flex flex-column h-100">
                            ...
                            <div class="mb-3 mt-1 w-50 pe-4 mobile-full-width">
                                ...
                                <input type="date" max="{{ now()->format('Y-m-d') }}"
                                    ...
                                    id="SleepDate" name="SleepDate" value="{{ old('SleepDate') }}">
                                @error('SleepDate')
                            ...
                            <div class="d-flex bed-wake-stack">
                                <div class="mb-3 w-50 me-4 mobile-full-width">
                                    ...
                                    <input type="time"
                                        ...
                                        id="BedTime" name="BedTime" value="{{ old('BedTime') }}">
                                    @error('BedTime')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3 w-50 me-4 mobile-full-width">
                                    ...
                                    <input type="time"
                                        ...
                                        id="WakeTime" name="WakeTime" value="{{ old('WakeTime') }}">
                                    @error('WakeTime')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
