    ...
    <div class="container">
        ...
        <div class="mb-3">
            <a href="{{ route('admin.dashboard') }}" class="back-link h2 fw-bold">
                <i class="fa fa-chevron-left me-2 h4 fw-bold"></i>Edit Support Resource
            </a>
        </div>

        <!-- Edit Resource Form -->
        <div class="custom-form-container p-4">
            <form method="POST" action="{{ route('admin.update.resource', $resource->SupportResourceID) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-6 mb-3 mb-lg-0">
                        <div class="left-column-wrapper d-flex flex-column h-100">
                            ...
                            <p class="custom-header-desc mb-1">Update the support resource details.</p>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="ResourceTitle" name="ResourceTitle"
                                    value="{{ old('ResourceTitle', $resource->ResourceTitle) }}"
                                ...
                                <select class="form-select custom-input @error('ResourceCategory') is-invalid @enderror"
                                    ...
                                    @foreach ($resource_categories as $category)
                                        <option value="{{ $category->ResourceCategoryID }}"
                                            {{ old('ResourceCategory', $resource->ResourceCategory) == $category->ResourceCategoryID ? 'selected' : '' }}>
                                            {{ $category->Name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="Phone" name="Phone" value="{{ old('Phone', $resource->Phone) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="Location" name="Location" value="{{ old('Location', $resource->Location) }}"
                    ...
                    <div class="col-lg-6">
                        <div class="content-wrapper">
                            ...
                            <textarea class="form-control custom-input content-area-height @error('Description') is-invalid @enderror"
                                id="Description" name="Description" placeholder="Enter resource details..." required>{{ old('Description', $resource->Description) }}</textarea>
                            @error('Description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
